...
x = [stats["runs"] for batter, stats in sorted_batters[:15]]
y = [stats["strike_rate"] for batter, stats in sorted_batters[:15]]
labels = [batter for batter, stats in sorted_batters[:15]]

plt.scatter(x, y)
plt.xlabel("Runs")
plt.ylabel("Strike Rate")
plt.title("Top 15 Batters (Runs vs Strike Rate)")
